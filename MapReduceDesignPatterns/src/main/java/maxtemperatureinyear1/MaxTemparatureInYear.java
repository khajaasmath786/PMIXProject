...
public class MaxTemparatureInYear extends Configured implements Tool
{
...
// Tool runner will call run method automatically	
	 ...
	 */
	Job job = new Job();
	job.setJarByClass(MaxTemparatureInYear.class);
	job.setJobName("MaxTemparatureInYear");
	...
	job.setMapperClass(MaxTemparatureInYearMapper.class);
	...
	job.setReducerClass(MaxTemparatureInYearReducer.class);
    ...
    {
    	int exitCode= ToolRunner.run(new Configuration(),new MaxTemparatureInYear(),args);
