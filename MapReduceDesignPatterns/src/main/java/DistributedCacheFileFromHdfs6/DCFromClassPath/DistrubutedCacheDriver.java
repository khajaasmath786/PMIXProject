package DistributedCacheFileFromHdfs6.DCFromClassPath;
...
// Tool runner will call run method automatically	
	...
	if (args.length != 2)
	{
		 ...
		 // Input/DistributedCache.txt Output/DistributedCache
	    System.exit(-1);
	}
	...
	URI uri;
	DistributedCache.addFileToClassPath(new Path("Input/DistributedCache.txt"), job.getConfiguration());
